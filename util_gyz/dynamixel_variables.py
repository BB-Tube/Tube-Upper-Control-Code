...
from .abstract_motor import Mode
from .units import *
...
class Unit_Dynamixel(Enum):
    UNITLESS = auto()
    PWM_SLOPE = auto() ### mV/msec
    PWM = auto() ### % of Voltage
    INDIRECT_ADDRESS = auto()
    INDIRECT_DATA = auto()
...
default_parameters = {
    Address.DEFAULT:{
        ...
        Unit_Rotation.REVOLUTION : 1 / 4096,
        Unit_Dynamixel.UNITLESS : 1,
        Unit_Time.MILLISECOND : 1,
        Unit_Time.MICROSECOND : 2,
        Unit_Current.MILLIAMP : 2.69,
        Unit_Voltage.VOLT : 0.1,
        Unit_Rotational_Speed.REV_PER_MIN : 0.229,
        Unit_Rotational_Acceleration.REV_PER_MIN_SQUARED : 214.577,
        Unit_Temp.CELCIUS : 1.0,
        Unit_Dynamixel.PWM_SLOPE : 1.977,
        Unit_Dynamixel.PWM : 0.113
        },
    ...
    Address.RETURN_DELAY_TIME:{
        Data.RANGE : [0, 254],
        Data.UNIT : Unit_Time.MICROSECOND
        },
    Address.DRIVE_MODE:{
        Data.RANGE : [0, 5]
        },
    ...
    Address.HOMING_OFFSET:{
        ...
        Data.UNIT : Unit_Rotation.REVOLUTION
        },
    Address.MOVING_THRESHOLD:{
        Data.SIZE : 4,
        Data.RANGE : [0, 1023],
        Data.UNIT : Unit_Rotational_Speed.REV_PER_MIN
        },
    Address.TEMPERATURE_LIMIT: {
        Data.RANGE : [0, 100],
        Data.UNIT : Unit_Temp.CELCIUS
        },
    Address.MAX_VOlTAGE_LIMIT: { 
        Data.SIZE : 2,
        Data.RANGE : [110, 300], 
        Data.UNIT : Unit_Voltage.VOLT
        },
    ...
    Address.PROFILE_ACCELERATION:{
        Data.SIZE: 4,
        Data.UNIT: Unit_Rotational_Acceleration.REV_PER_MIN_SQUARED
    },
